...
let difficulty = document.getElementById("selectedOption").value;
...
// let e = document.getElementById("selectedOption");
// let strUser = e.options[e.selectedIndex].text;

getQuestions(difficulty);

function handleChange() {
  difficulty = document.getElementById("selectedOption").value;
  getQuestions(difficulty);
}
...
getNewQuestion = () =>{
    if(availableQuestions.length === 0 || questionCounter >= MAX_QUESTIONS){
        ...
        return window.location.assign('http://localhost/Quiz-project/phpSHIT/end.php');
      };    
      questionCounter++;
